...
elseif(isset($_GET['act']) AND $_GET['act']=='edit') {
    $isi = mysqli_fetch_array(mysqli_query($connect,"SELECT * FROM member WHERE id_member = '$_GET[id]'"));
...
elseif(isset($_GET['act']) AND $_GET['act']=='proses_edit') {
    $edit = mysqli_query($connect,"UPDATE member SET nama_depan = '$_POST[nama_depan]', nama_belakang = '$_POST[nama_belakang]', alamat = '$_POST[alamat]',
...
elseif(isset($_GET['act']) AND $_GET['act']=='hapus') {
    $hapus = mysqli_query($connect,"DELETE FROM member
